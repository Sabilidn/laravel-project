        ...
        <div class="px-4 py-6 sm:px-0">
            ...
            @if ($showForm)
                <div class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                    <h2 class="text-xl font-semibold mb-4">{{ $editingProductId ? 'Edit Product' : 'Add New Product' }}</h2>
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-md">
                <ul role="list" class="divide-y divide-gray-200">
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="flex-1">
                                        ...
                                        <div class="mt-2 flex items-center text-sm text-gray-500">
                                            <span class="mr-4">Price: ${{ number_format($product->price, 2) }}</span>
                    ...
                    @empty
                        <li>
                            <div class="px-4 py-4 sm:px-6">
                                <p class="text-gray-500">No products found. <button wire:click="toggleForm"
